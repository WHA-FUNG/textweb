...
weekMethod:"ISO8601",//周算法.不同的地方有一些差异 ISO8601:规定第一个星期四为第一周,默认值 MSExcel:1月1日所在的周
position:{},
lang:"auto",
skin:"default",
dateFmt:"yyyy-MM-dd",//日期显示格式 http://www.my97.net/dp/demo/resource/2.2.asp#m224
...
autoPickDate:null,				//为false时 点日期的时候不自动输入,而是要通过确定才能输入;为true时 即点击日期即可返回日期值;为null时(推荐使用) 如果有时间置为false 否则置为true
